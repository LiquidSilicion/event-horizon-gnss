...
//    );
    ...
    // Invert the Active-High button to Active-Low
    wire rst_n_internal = ~rst_n; 

    // A 27-bit counter (100MHz / 2^27 ≈ 0.74 Hz blink)
    ...
    // Assign LEDs to the counter
    assign led_dump_valid = blink_cnt[26]; // Should blink slowly (~0.74 Hz)
    assign led_tracking_ok = 1'b1;         // Should be solid ON
